...
$(full_target): $(full_src_files) $(droiddoc_templates) $(droiddoc) $(html_dir_files) $(full_java_lib_deps) $(LOCAL_ADDITIONAL_DEPENDENCIES)
	...
	$(hide) ( \
		javadoc \
                ...
                -docletpath $(subst :,\;,$(strip $(PRIVATE_DOCLETPATH))) \
                -templatedir $(PRIVATE_CUSTOM_TEMPLATE_DIR) \
                $(PRIVATE_DROIDDOC_HTML_DIR) \
                $(PRIVATE_ADDITIONAL_HTML_DIR) \
                $(addprefix -bootclasspath ,$(subst :,\;,$(strip $(PRIVATE_BOOTCLASSPATH)))) \
                $(addprefix -classpath ,$(subst :,\;,$(strip $(PRIVATE_CLASSPATH)))) \
                -sourcepath $(PRIVATE_SOURCE_PATH)$(addprefix \;,$(subst :,\;,$(strip $(PRIVATE_CLASSPATH)))) \
                -d $(PRIVATE_OUT_DIR) \
