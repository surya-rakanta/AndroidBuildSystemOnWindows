...
@echo "target Java: $(PRIVATE_MODULE) ($(PRIVATE_CLASS_INTERMEDIATES_DIR) Compile with $(TARGET_JAVAC) and parameter $(PRIVATE_BOOTCLASSPATH) on $(full_classes_compiled_jar) )"
