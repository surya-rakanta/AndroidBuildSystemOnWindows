...
function make()
{
	...
	#echo $@
    #$(get_make_command) "$@"
	#command make -C /d/Projects/Lollipop/platform -f build/core/main.mk all_modules BUILD_MODULES_IN_PATHS= d:/Projects/Lollipop/platform/packages/apps/Contacts -p > myMake4.txt
	...
	#command make -C /d/Projects/Lollipop/platform -f build/core/main.mk out/target/product/generic/obj/APPS/Contacts_intermediates/package.apk -p > myMake5.txt
	command make -C /d/Projects/Lollipop/platform -f build/core/main.mk out/target/product/generic/system/priv-app/Contacts/Contacts.apk
	#command make -C /d/Projects/Lollipop/platform -f build/core/main.mk out/target/common/docs/api-stubs-timestamp -p > myMake6.txt
	#command make -C /d/Projects/Lollipop/platform -f build/core/main.mk out/target/common/docs/api-stubs-timestamp
	#command make -C /d/Projects/Lollipop/platform -f build/core/main.mk out/target/common/obj/JAVA_LIBRARIES/bouncycastle_intermediates/classes-full-debug.jar
	...
	#command make -C /d/Projects/Lollipop/platform -f build/core/main.mk BUILD_MODULES_IN_PATHS=d:/Projects/Lollipop/platform/packages/apps/Contacts -p > myMake5.txt
    local ret=$?
...
addcompletions
mmma d:/Projects/Lollipop/platform/packages/apps/Contacts
